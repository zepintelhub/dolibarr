...
/**
 *   	\file       statistique_list.php
 *		\ingroup    gestionnaire
 *		\brief      List page for statistique
 */
...
require_once __DIR__.'/class/statistique.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('gestionnaire', 'statistique', 'write');
	$permissiontodelete = $user->hasRight('gestionnaire', 'statistique', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Statistique';
	$objectlabel = 'Statistique';
...
$title = $langs->trans("Statistiques");
//$help_url = "EN:Module_Statistique|FR:Module_Statistique_FR|ES:Módulo_Statistique";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/gestionnaire/statistique_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/gestionnaire/statistique_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendStatistiqueRef";
$modelmail = "statistique";
$objecttmp = new Statistique($db);
