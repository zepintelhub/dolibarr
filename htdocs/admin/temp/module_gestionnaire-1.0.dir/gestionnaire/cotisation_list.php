...
/**
 *   	\file       cotisation_list.php
 *		\ingroup    gestionnaire
 *		\brief      List page for cotisation
 */
...
require_once __DIR__.'/class/cotisation.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('gestionnaire', 'cotisation', 'write');
	$permissiontodelete = $user->hasRight('gestionnaire', 'cotisation', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Cotisation';
	$objectlabel = 'Cotisation';
...
$title = $langs->trans("Cotisations");
//$help_url = "EN:Module_Cotisation|FR:Module_Cotisation_FR|ES:Módulo_Cotisation";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/gestionnaire/cotisation_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/gestionnaire/cotisation_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendCotisationRef";
$modelmail = "cotisation";
$objecttmp = new Cotisation($db);
