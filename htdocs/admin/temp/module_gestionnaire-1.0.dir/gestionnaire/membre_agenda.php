...
/**
 *  \file       membre_agenda.php
 *  \ingroup    gestionnaire
 *  \brief      Tab of events on Membre
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Membre")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Membre"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_membre_'.$object->id;
