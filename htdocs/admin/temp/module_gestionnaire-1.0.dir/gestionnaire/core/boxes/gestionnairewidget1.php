...
/**
 * \file    gestionnaire/core/boxes/gestionnairewidget1.php
 * \ingroup gestionnaire
 * \brief   Widget provided by Gestionnaire
 *
 ...
 */
class gestionnairewidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "gestionnairebox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "gestionnaire@gestionnaire";
	 ...
	 */
	public $depends = array('gestionnaire');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "gestionnaire@gestionnaire"));
		...
		// $this->hidden = !$user->hasRight('gestionnaire', 'myobject', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/gestionnaire/class/gestionnaire.class.php");

		// Populate the head at runtime
		$text = $langs->trans("GestionnaireBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_gestionnaire@gestionnaire',
