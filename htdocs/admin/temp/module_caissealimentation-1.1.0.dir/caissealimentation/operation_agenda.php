...
/**
 *  \file       operation_agenda.php
 *  \ingroup    caissealimentation
 *  \brief      Tab of events on Operation
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Operation")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Operation"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_operation_'.$object->id;
