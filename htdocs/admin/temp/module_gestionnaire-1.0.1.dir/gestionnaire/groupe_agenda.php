...
/**
 *  \file       groupe_agenda.php
 *  \ingroup    gestionnaire
 *  \brief      Tab of events on Groupe
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Groupe")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Groupe"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_groupe_'.$object->id;
