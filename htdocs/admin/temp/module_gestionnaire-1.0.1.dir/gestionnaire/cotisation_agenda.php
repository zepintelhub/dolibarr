...
/**
 *  \file       cotisation_agenda.php
 *  \ingroup    gestionnaire
 *  \brief      Tab of events on Cotisation
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Cotisation")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Cotisation"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_cotisation_'.$object->id;
