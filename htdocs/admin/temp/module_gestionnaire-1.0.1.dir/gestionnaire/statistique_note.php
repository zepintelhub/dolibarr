...
/**
 *  \file       statistique_note.php
 *  \ingroup    gestionnaire
 *  \brief      Tab for notes on Statistique
 */
...
$title = $langs->trans('Statistique').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Statistique"), -1, $object->picto);
