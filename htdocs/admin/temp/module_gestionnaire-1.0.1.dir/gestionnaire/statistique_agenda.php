...
/**
 *  \file       statistique_agenda.php
 *  \ingroup    gestionnaire
 *  \brief      Tab of events on Statistique
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Statistique")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Statistique"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_statistique_'.$object->id;
