...
/**
 *  \file       statistique_contact.php
 *  \ingroup    gestionnaire
 *  \brief      Tab for contacts linked to Statistique
 */
...
$title = $langs->trans("Statistique")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Statistique"), -1, $object->picto);
