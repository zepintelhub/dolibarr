...
/**
 *  \file       echeancepaiement_agenda.php
 *  \ingroup    caissealimentation
 *  \brief      Tab of events on EcheancePaiement
 */
...
if ($object->id > 0) {
	$title = $langs->trans("EcheancePaiement")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("EcheancePaiement"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_echeancepaiement_'.$object->id;
