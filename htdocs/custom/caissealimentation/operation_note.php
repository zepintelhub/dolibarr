...
/**
 *  \file       operation_note.php
 *  \ingroup    caissealimentation
 *  \brief      Tab for notes on Operation
 */
...
$title = $langs->trans('Operation').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Operation"), -1, $object->picto);
