...
/**
 *  \file       core/modules/caissealimentation/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_operation
 */
class pdf_standard_operation extends ModelePDFOperation
{
	/**
	 ...
	 *
	 *  @param		Operation	$object				Object to generate
	 ...
	 *
	 *  @param	TCPDF		$pdf     		Object PDF
	 *  @param  Operation	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('CAISSEALIMENTATION_DRAFT_WATERMARK') && $object->statut == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('CAISSEALIMENTATION_DRAFT_WATERMARK')));
		}
