...
/**
 * \file    caissealimentation/core/boxes/caissealimentationwidget1.php
 * \ingroup caissealimentation
 * \brief   Widget provided by CaisseAlimentation
 *
 ...
 */
class caissealimentationwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "caissealimentationbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "caissealimentation@caissealimentation";
	 ...
	 */
	public $depends = array('caissealimentation');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "caissealimentation@caissealimentation"));
		...
		// $this->hidden = !$user->hasRight('caissealimentation', 'myobject', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/caissealimentation/class/caissealimentation.class.php");

		// Populate the head at runtime
		$text = $langs->trans("CaisseAlimentationBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_caissealimentation@caissealimentation',
