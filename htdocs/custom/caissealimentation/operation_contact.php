...
/**
 *  \file       operation_contact.php
 *  \ingroup    caissealimentation
 *  \brief      Tab for contacts linked to Operation
 */
...
$title = $langs->trans("Operation")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Operation"), -1, $object->picto);
