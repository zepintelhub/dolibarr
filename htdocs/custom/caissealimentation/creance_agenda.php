...
/**
 *  \file       creance_agenda.php
 *  \ingroup    caissealimentation
 *  \brief      Tab of events on Creance
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Creance")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Creance"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_creance_'.$object->id;
